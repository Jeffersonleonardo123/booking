...
class ProfessionalsControllerTest < ActionController::TestCase
  ...
  test "should create professional" do
    assert_difference('Professional.count') do
      post :create, professional: { active: @professional.active, address: @professional.address, city: @professional.city, company_id: @professional.company_id, complement: @professional.complement, fullname: @professional.fullname, neighborhood: @professional.neighborhood, phone: @professional.phone, state: @professional.state, zip: @professional.zip }
    end
